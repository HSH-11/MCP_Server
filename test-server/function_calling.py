...
from langchain_core.tools import tool  # 랭체인에서 함수를 도구로 등록할 수 있게 해주는 데코레이터
from langchain_openai import ChatOpenAI # OpenAI LLM을 랭체인에서 사용하기 위한 클래스
from langchain.agents import initialize_agent, AgentType, Tool # 에이전트 초기화 및 도구 구성에 필요한 클래스
